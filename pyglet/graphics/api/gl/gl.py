...
Generated by tools/gen_opengl/gengl.py.
Do not modify this file.
"""
from __future__ import annotations

from ctypes import (
    CFUNCTYPE, POINTER, Structure, c_byte, c_char, c_double, c_float, c_int,
...
class GLFunctions:
    ...
    def __init__(self) -> None:
        self.glActiveProgramEXT = _link_function('glActiveProgramEXT', None, [GLuint], requires=None)
        self.glActiveShaderProgram = _link_function('glActiveShaderProgram', None, [GLuint, GLuint], requires='OpenGL 3.1')
        self.glActiveShaderProgramEXT = _link_function('glActiveShaderProgramEXT', None, [GLuint, GLuint], requires=None)
        self.glActiveTexture = _link_function('glActiveTexture', None, [GLenum], requires='OpenGL 2.0')
        ...
        self.glBeginQuery = _link_function('glBeginQuery', None, [GLenum, GLuint], requires='OpenGL 3.0')
        ...
        self.glBindBuffer = _link_function('glBindBuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
        self.glBindBufferBase = _link_function('glBindBufferBase', None, [GLenum, GLuint, GLuint], requires='OpenGL 3.0')
        self.glBindBufferRange = _link_function('glBindBufferRange', None, [GLenum, GLuint, GLuint, GLintptr, GLsizeiptr], requires='OpenGL 3.0')
        ...
        self.glBindFramebuffer = _link_function('glBindFramebuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
        self.glBindFramebufferEXT = _link_function('glBindFramebufferEXT', None, [GLenum, GLuint], requires=None)
        self.glBindImageTexture = _link_function('glBindImageTexture', None, [GLuint, GLuint, GLint, GLboolean, GLint, GLenum, GLenum], requires='OpenGL 3.1')
        self.glBindImageTextures = _link_function('glBindImageTextures', None, [GLuint, GLsizei, POINTER(GLuint)], requires='OpenGL 4.4')
        self.glBindProgramPipeline = _link_function('glBindProgramPipeline', None, [GLuint], requires='OpenGL 3.1')
        self.glBindProgramPipelineEXT = _link_function('glBindProgramPipelineEXT', None, [GLuint], requires=None)
        self.glBindRenderbuffer = _link_function('glBindRenderbuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
        self.glBindRenderbufferEXT = _link_function('glBindRenderbufferEXT', None, [GLenum, GLuint], requires=None)
        self.glBindSampler = _link_function('glBindSampler', None, [GLuint, GLuint], requires='OpenGL 3.0')
        self.glBindSamplers = _link_function('glBindSamplers', None, [GLuint, GLsizei, POINTER(GLuint)], requires='OpenGL 4.4')
        self.glBindTexture = _link_function('glBindTexture', None, [GLenum, GLuint], requires='OpenGL 2.0')
        ...
        self.glBindTransformFeedback = _link_function('glBindTransformFeedback', None, [GLenum, GLuint], requires='OpenGL 3.0')
        self.glBindVertexArray = _link_function('glBindVertexArray', None, [GLuint], requires='OpenGL 3.0')
        self.glBindVertexBuffer = _link_function('glBindVertexBuffer', None, [GLuint, GLuint, GLintptr, GLsizei], requires='OpenGL 3.1')
        ...
        self.glBlendColor = _link_function('glBlendColor', None, [GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 2.0')
        self.glBlendEquation = _link_function('glBlendEquation', None, [GLenum], requires='OpenGL 2.0')
        self.glBlendEquationSeparate = _link_function('glBlendEquationSeparate', None, [GLenum, GLenum], requires='OpenGL 2.0')
        self.glBlendEquationSeparatei = _link_function('glBlendEquationSeparatei', None, [GLuint, GLenum, GLenum], requires='OpenGL 3.2')
        self.glBlendEquationi = _link_function('glBlendEquationi', None, [GLuint, GLenum], requires='OpenGL 3.2')
        self.glBlendFunc = _link_function('glBlendFunc', None, [GLenum, GLenum], requires='OpenGL 2.0')
        self.glBlendFuncSeparate = _link_function('glBlendFuncSeparate', None, [GLenum, GLenum, GLenum, GLenum], requires='OpenGL 2.0')
        self.glBlendFuncSeparatei = _link_function('glBlendFuncSeparatei', None, [GLuint, GLenum, GLenum, GLenum, GLenum], requires='OpenGL 3.2')
        self.glBlendFunci = _link_function('glBlendFunci', None, [GLuint, GLenum, GLenum], requires='OpenGL 3.2')
        ...
        self.glBufferData = _link_function('glBufferData', None, [GLenum, GLsizeiptr, POINTER(GLvoid), GLenum], requires='OpenGL 2.0')
        self.glBufferStorage = _link_function('glBufferStorage', None, [GLenum, GLsizeiptr, POINTER(GLvoid), GLbitfield], requires='OpenGL 4.4')
        self.glBufferSubData = _link_function('glBufferSubData', None, [GLenum, GLintptr, GLsizeiptr, POINTER(GLvoid)], requires='OpenGL 2.0')
        self.glCheckFramebufferStatus = _link_function('glCheckFramebufferStatus', GLenum, [GLenum], requires='OpenGL 2.0')
        ...
        self.glClear = _link_function('glClear', None, [GLbitfield], requires='OpenGL 2.0')
        ...
        self.glClearColor = _link_function('glClearColor', None, [GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 2.0')
        self.glClearDepth = _link_function('glClearDepth', None, [GLdouble], requires='OpenGL 1.0')
        self.glClearDepthf = _link_function('glClearDepthf', None, [GLfloat], requires='OpenGL 2.0')
        ...
        self.glClearStencil = _link_function('glClearStencil', None, [GLint], requires='OpenGL 2.0')
        ...
        self.glClientWaitSync = _link_function('glClientWaitSync', GLenum, [GLsync, GLbitfield, GLuint64], requires='OpenGL 3.0')
        self.glClipControl = _link_function('glClipControl', None, [GLenum, GLenum], requires='OpenGL 4.5')
        self.glColorMask = _link_function('glColorMask', None, [GLboolean, GLboolean, GLboolean, GLboolean], requires='OpenGL 2.0')
        self.glColorMaski = _link_function('glColorMaski', None, [GLuint, GLboolean, GLboolean, GLboolean, GLboolean], requires='OpenGL 3.2')
        ...
        self.glCompressedTexImage2D = _link_function('glCompressedTexImage2D', None, [GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, POINTER(GLvoid)], requires='OpenGL 2.0')
        self.glCompressedTexImage3D = _link_function('glCompressedTexImage3D', None, [GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glCompressedTexSubImage2D = _link_function('glCompressedTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 2.0')
        self.glCompressedTexSubImage3D = _link_function('glCompressedTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glCopyBufferSubData = _link_function('glCopyBufferSubData', None, [GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr], requires='OpenGL 3.0')
        self.glCopyImageSubData = _link_function('glCopyImageSubData', None, [GLuint, GLenum, GLint, GLint, GLint, GLint, GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei], requires='OpenGL 3.2')
        ...
        self.glCopyTexImage2D = _link_function('glCopyTexImage2D', None, [GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint], requires='OpenGL 2.0')
        ...
        self.glCopyTexSubImage2D = _link_function('glCopyTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
        self.glCopyTexSubImage3D = _link_function('glCopyTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
        ...
        self.glCreateShaderProgramEXT = _link_function('glCreateShaderProgramEXT', GLuint, [GLenum, POINTER(GLchar)], requires=None)
        self.glCreateShaderProgramv = _link_function('glCreateShaderProgramv', GLuint, [GLenum, GLsizei, POINTER(POINTER(GLchar))], requires='OpenGL 3.1')
        self.glCreateShaderProgramvEXT = _link_function('glCreateShaderProgramvEXT', GLuint, [GLenum, GLsizei, POINTER(POINTER(GLchar))], requires=None)
        ...
        self.glCullFace = _link_function('glCullFace', None, [GLenum], requires='OpenGL 2.0')
        self.glDebugMessageCallback = _link_function('glDebugMessageCallback', None, [GLDEBUGPROC, POINTER(GLvoid)], requires='OpenGL 3.2')
        self.glDebugMessageControl = _link_function('glDebugMessageControl', None, [GLenum, GLenum, GLenum, GLsizei, POINTER(GLuint), GLboolean], requires='OpenGL 3.2')
        self.glDebugMessageInsert = _link_function('glDebugMessageInsert', None, [GLenum, GLenum, GLuint, GLenum, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
        self.glDeleteBuffers = _link_function('glDeleteBuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glDeleteFramebuffers = _link_function('glDeleteFramebuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        ...
        self.glDeleteProgramPipelines = _link_function('glDeleteProgramPipelines', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glDeleteProgramPipelinesEXT = _link_function('glDeleteProgramPipelinesEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
        self.glDeleteQueries = _link_function('glDeleteQueries', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glDeleteRenderbuffers = _link_function('glDeleteRenderbuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glDeleteRenderbuffersEXT = _link_function('glDeleteRenderbuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
        self.glDeleteSamplers = _link_function('glDeleteSamplers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glDeleteShader = _link_function('glDeleteShader', None, [GLuint], requires='OpenGL 2.0')
        self.glDeleteSync = _link_function('glDeleteSync', None, [GLsync], requires='OpenGL 3.0')
        self.glDeleteTextures = _link_function('glDeleteTextures', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glDeleteTransformFeedbacks = _link_function('glDeleteTransformFeedbacks', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glDeleteVertexArrays = _link_function('glDeleteVertexArrays', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glDepthFunc = _link_function('glDepthFunc', None, [GLenum], requires='OpenGL 2.0')
        self.glDepthMask = _link_function('glDepthMask', None, [GLboolean], requires='OpenGL 2.0')
        ...
        self.glDepthRangef = _link_function('glDepthRangef', None, [GLfloat, GLfloat], requires='OpenGL 2.0')
        self.glDetachShader = _link_function('glDetachShader', None, [GLuint, GLuint], requires='OpenGL 2.0')
        self.glDisable = _link_function('glDisable', None, [GLenum], requires='OpenGL 2.0')
        ...
        self.glDisablei = _link_function('glDisablei', None, [GLenum, GLuint], requires='OpenGL 3.2')
        self.glDispatchCompute = _link_function('glDispatchCompute', None, [GLuint, GLuint, GLuint], requires='OpenGL 3.1')
        self.glDispatchComputeIndirect = _link_function('glDispatchComputeIndirect', None, [GLintptr], requires='OpenGL 3.1')
        self.glDrawArrays = _link_function('glDrawArrays', None, [GLenum, GLint, GLsizei], requires='OpenGL 2.0')
        self.glDrawArraysIndirect = _link_function('glDrawArraysIndirect', None, [GLenum, POINTER(GLvoid)], requires='OpenGL 3.1')
        self.glDrawArraysInstanced = _link_function('glDrawArraysInstanced', None, [GLenum, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
        ...
        self.glDrawBuffers = _link_function('glDrawBuffers', None, [GLsizei, POINTER(GLenum)], requires='OpenGL 3.0')
        self.glDrawElements = _link_function('glDrawElements', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
        ...
        self.glDrawElementsBaseVertexOES = _link_function('glDrawElementsBaseVertexOES', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLint], requires=None)
        self.glDrawElementsIndirect = _link_function('glDrawElementsIndirect', None, [GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.1')
        self.glDrawElementsInstanced = _link_function('glDrawElementsInstanced', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 3.0')
        ...
        self.glDrawElementsInstancedBaseVertexOES = _link_function('glDrawElementsInstancedBaseVertexOES', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLsizei, GLint], requires=None)
        ...
        self.glDrawRangeElements = _link_function('glDrawRangeElements', None, [GLenum, GLuint, GLuint, GLsizei, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glDrawRangeElementsBaseVertexOES = _link_function('glDrawRangeElementsBaseVertexOES', None, [GLenum, GLuint, GLuint, GLsizei, GLenum, POINTER(GLvoid), GLint], requires=None)
        ...
        self.glEnable = _link_function('glEnable', None, [GLenum], requires='OpenGL 2.0')
        ...
        self.glEnablei = _link_function('glEnablei', None, [GLenum, GLuint], requires='OpenGL 3.2')
        self.glEndConditionalRender = _link_function('glEndConditionalRender', None, [], requires='OpenGL 3.0')
        self.glEndQuery = _link_function('glEndQuery', None, [GLenum], requires='OpenGL 3.0')
        ...
        self.glFenceSync = _link_function('glFenceSync', GLsync, [GLenum, GLbitfield], requires='OpenGL 3.0')
        self.glFinish = _link_function('glFinish', None, [], requires='OpenGL 2.0')
        self.glFlush = _link_function('glFlush', None, [], requires='OpenGL 2.0')
        ...
        self.glFramebufferParameteri = _link_function('glFramebufferParameteri', None, [GLenum, GLenum, GLint], requires='OpenGL 3.1')
        self.glFramebufferRenderbuffer = _link_function('glFramebufferRenderbuffer', None, [GLenum, GLenum, GLenum, GLuint], requires='OpenGL 2.0')
        ...
        self.glFramebufferTexture2D = _link_function('glFramebufferTexture2D', None, [GLenum, GLenum, GLenum, GLuint, GLint], requires='OpenGL 2.0')
        ...
        self.glFramebufferTextureARB = _link_function('glFramebufferTextureARB', None, [GLenum, GLenum, GLuint, GLint], requires=None)
        self.glFramebufferTextureEXT = _link_function('glFramebufferTextureEXT', None, [GLenum, GLenum, GLuint, GLint], requires=None)
        self.glFramebufferTextureFaceARB = _link_function('glFramebufferTextureFaceARB', None, [GLenum, GLenum, GLuint, GLint, GLenum], requires=None)
        ...
        self.glFramebufferTextureLayerARB = _link_function('glFramebufferTextureLayerARB', None, [GLenum, GLenum, GLuint, GLint, GLint], requires=None)
        self.glFrontFace = _link_function('glFrontFace', None, [GLenum], requires='OpenGL 2.0')
        self.glGenBuffers = _link_function('glGenBuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glGenFramebuffers = _link_function('glGenFramebuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glGenFramebuffersEXT = _link_function('glGenFramebuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
        self.glGenProgramPipelines = _link_function('glGenProgramPipelines', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glGenProgramPipelinesEXT = _link_function('glGenProgramPipelinesEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
        self.glGenQueries = _link_function('glGenQueries', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glGenRenderbuffers = _link_function('glGenRenderbuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glGenRenderbuffersEXT = _link_function('glGenRenderbuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
        self.glGenSamplers = _link_function('glGenSamplers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glGenTextures = _link_function('glGenTextures', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
        self.glGenTransformFeedbacks = _link_function('glGenTransformFeedbacks', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glGenVertexArrays = _link_function('glGenVertexArrays', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glGenerateMipmap = _link_function('glGenerateMipmap', None, [GLenum], requires='OpenGL 2.0')
        ...
        self.glGetActiveUniformBlockName = _link_function('glGetActiveUniformBlockName', None, [GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.0')
        self.glGetActiveUniformBlockiv = _link_function('glGetActiveUniformBlockiv', None, [GLuint, GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
        ...
        self.glGetActiveUniformsiv = _link_function('glGetActiveUniformsiv', None, [GLuint, GLsizei, POINTER(GLuint), GLenum, POINTER(GLint)], requires='OpenGL 3.0')
        ...
        self.glGetBooleani_v = _link_function('glGetBooleani_v', None, [GLenum, GLuint, POINTER(GLboolean)], requires='OpenGL 3.1')
        self.glGetBooleanv = _link_function('glGetBooleanv', None, [GLenum, POINTER(GLboolean)], requires='OpenGL 2.0')
        self.glGetBufferParameteri64v = _link_function('glGetBufferParameteri64v', None, [GLenum, GLenum, POINTER(GLint64)], requires='OpenGL 3.0')
        self.glGetBufferParameteriv = _link_function('glGetBufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        self.glGetBufferPointerv = _link_function('glGetBufferPointerv', None, [GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glGetDebugMessageLog = _link_function('glGetDebugMessageLog', GLuint, [GLuint, GLsizei, POINTER(GLenum), POINTER(GLenum), POINTER(GLuint), POINTER(GLenum), POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
        ...
        self.glGetError = _link_function('glGetError', GLenum, [], requires='OpenGL 2.0')
        self.glGetFloati_v = _link_function('glGetFloati_v', None, [GLenum, GLuint, POINTER(GLfloat)], requires='OpenGL 4.1')
        self.glGetFloatv = _link_function('glGetFloatv', None, [GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
        ...
        self.glGetFramebufferAttachmentParameteriv = _link_function('glGetFramebufferAttachmentParameteriv', None, [GLenum, GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        ...
        self.glGetFramebufferParameteriv = _link_function('glGetFramebufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
        self.glGetGraphicsResetStatus = _link_function('glGetGraphicsResetStatus', GLenum, [], requires='OpenGL 3.2')
        self.glGetImageHandleARB = _link_function('glGetImageHandleARB', GLuint64, [GLuint, GLint, GLboolean, GLint, GLenum], requires=None)
        self.glGetInteger64i_v = _link_function('glGetInteger64i_v', None, [GLenum, GLuint, POINTER(GLint64)], requires='OpenGL 3.0')
        self.glGetInteger64v = _link_function('glGetInteger64v', None, [GLenum, POINTER(GLint64)], requires='OpenGL 3.0')
        self.glGetIntegeri_v = _link_function('glGetIntegeri_v', None, [GLenum, GLuint, POINTER(GLint)], requires='OpenGL 3.0')
        self.glGetIntegerv = _link_function('glGetIntegerv', None, [GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        ...
        self.glGetInternalformativ = _link_function('glGetInternalformativ', None, [GLenum, GLenum, GLenum, GLsizei, POINTER(GLint)], requires='OpenGL 3.0')
        self.glGetMultisamplefv = _link_function('glGetMultisamplefv', None, [GLenum, GLuint, POINTER(GLfloat)], requires='OpenGL 3.1')
        ...
        self.glGetObjectLabel = _link_function('glGetObjectLabel', None, [GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
        self.glGetObjectPtrLabel = _link_function('glGetObjectPtrLabel', None, [POINTER(GLvoid), GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
        self.glGetPointerv = _link_function('glGetPointerv', None, [GLenum, POINTER(GLvoid)], requires='OpenGL 3.2')
        self.glGetProgramBinary = _link_function('glGetProgramBinary', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLenum), POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glGetProgramInterfaceiv = _link_function('glGetProgramInterfaceiv', None, [GLuint, GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
        self.glGetProgramPipelineInfoLog = _link_function('glGetProgramPipelineInfoLog', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.1')
        self.glGetProgramPipelineInfoLogEXT = _link_function('glGetProgramPipelineInfoLogEXT', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires=None)
        self.glGetProgramPipelineiv = _link_function('glGetProgramPipelineiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
        self.glGetProgramPipelineivEXT = _link_function('glGetProgramPipelineivEXT', None, [GLuint, GLenum, POINTER(GLint)], requires=None)
        self.glGetProgramResourceIndex = _link_function('glGetProgramResourceIndex', GLuint, [GLuint, GLenum, POINTER(GLchar)], requires='OpenGL 3.1')
        self.glGetProgramResourceLocation = _link_function('glGetProgramResourceLocation', GLint, [GLuint, GLenum, POINTER(GLchar)], requires='OpenGL 3.1')
        ...
        self.glGetProgramResourceName = _link_function('glGetProgramResourceName', None, [GLuint, GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.1')
        self.glGetProgramResourceiv = _link_function('glGetProgramResourceiv', None, [GLuint, GLenum, GLuint, GLsizei, POINTER(GLenum), GLsizei, POINTER(GLsizei), POINTER(GLint)], requires='OpenGL 3.1')
        ...
        self.glGetQueryObjectuiv = _link_function('glGetQueryObjectuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.0')
        self.glGetQueryiv = _link_function('glGetQueryiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
        self.glGetRenderbufferParameteriv = _link_function('glGetRenderbufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        ...
        self.glGetSamplerParameterIiv = _link_function('glGetSamplerParameterIiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
        self.glGetSamplerParameterIuiv = _link_function('glGetSamplerParameterIuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
        self.glGetSamplerParameterfv = _link_function('glGetSamplerParameterfv', None, [GLuint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.0')
        self.glGetSamplerParameteriv = _link_function('glGetSamplerParameteriv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
        ...
        self.glGetShaderPrecisionFormat = _link_function('glGetShaderPrecisionFormat', None, [GLenum, GLenum, POINTER(GLint), POINTER(GLint)], requires='OpenGL 2.0')
        ...
        self.glGetString = _link_function('glGetString', POINTER(GLubyte), [GLenum], requires='OpenGL 2.0')
        ...
        self.glGetSynciv = _link_function('glGetSynciv', None, [GLsync, GLenum, GLsizei, POINTER(GLsizei), POINTER(GLint)], requires='OpenGL 3.0')
        self.glGetTexImage = _link_function('glGetTexImage', None, [GLenum, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 1.0')
        self.glGetTexLevelParameterfv = _link_function('glGetTexLevelParameterfv', None, [GLenum, GLint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glGetTexLevelParameteriv = _link_function('glGetTexLevelParameteriv', None, [GLenum, GLint, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
        self.glGetTexParameterIiv = _link_function('glGetTexParameterIiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
        self.glGetTexParameterIuiv = _link_function('glGetTexParameterIuiv', None, [GLenum, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
        self.glGetTexParameterfv = _link_function('glGetTexParameterfv', None, [GLenum, GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
        self.glGetTexParameteriv = _link_function('glGetTexParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        ...
        self.glGetUniformBlockIndex = _link_function('glGetUniformBlockIndex', GLuint, [GLuint, POINTER(GLchar)], requires='OpenGL 3.0')
        self.glGetUniformIndices = _link_function('glGetUniformIndices', None, [GLuint, GLsizei, POINTER(POINTER(GLchar)), POINTER(GLuint)], requires='OpenGL 3.0')
        ...
        self.glGetnUniformfv = _link_function('glGetnUniformfv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.2')
        self.glGetnUniformi64vARB = _link_function('glGetnUniformi64vARB', None, [GLuint, GLint, GLsizei, POINTER(GLint64)], requires=None)
        self.glGetnUniformiv = _link_function('glGetnUniformiv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.2')
        self.glGetnUniformui64vARB = _link_function('glGetnUniformui64vARB', None, [GLuint, GLint, GLsizei, POINTER(GLuint64)], requires=None)
        self.glGetnUniformuiv = _link_function('glGetnUniformuiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.2')
        self.glHint = _link_function('glHint', None, [GLenum, GLenum], requires='OpenGL 2.0')
        ...
        self.glInvalidateFramebuffer = _link_function('glInvalidateFramebuffer', None, [GLenum, GLsizei, POINTER(GLenum)], requires='OpenGL 3.0')
        ...
        self.glInvalidateSubFramebuffer = _link_function('glInvalidateSubFramebuffer', None, [GLenum, GLsizei, POINTER(GLenum), GLint, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
        ...
        self.glIsBuffer = _link_function('glIsBuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
        self.glIsEnabled = _link_function('glIsEnabled', GLboolean, [GLenum], requires='OpenGL 2.0')
        self.glIsEnabledi = _link_function('glIsEnabledi', GLboolean, [GLenum, GLuint], requires='OpenGL 3.2')
        self.glIsFramebuffer = _link_function('glIsFramebuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
        ...
        self.glIsProgramPipeline = _link_function('glIsProgramPipeline', GLboolean, [GLuint], requires='OpenGL 3.1')
        self.glIsProgramPipelineEXT = _link_function('glIsProgramPipelineEXT', GLboolean, [GLuint], requires=None)
        self.glIsQuery = _link_function('glIsQuery', GLboolean, [GLuint], requires='OpenGL 3.0')
        self.glIsRenderbuffer = _link_function('glIsRenderbuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
        self.glIsRenderbufferEXT = _link_function('glIsRenderbufferEXT', GLboolean, [GLuint], requires=None)
        self.glIsSampler = _link_function('glIsSampler', GLboolean, [GLuint], requires='OpenGL 3.0')
        self.glIsShader = _link_function('glIsShader', GLboolean, [GLuint], requires='OpenGL 2.0')
        self.glIsSync = _link_function('glIsSync', GLboolean, [GLsync], requires='OpenGL 3.0')
        self.glIsTexture = _link_function('glIsTexture', GLboolean, [GLuint], requires='OpenGL 2.0')
        self.glIsTextureHandleResidentARB = _link_function('glIsTextureHandleResidentARB', GLboolean, [GLuint64], requires=None)
        self.glIsTransformFeedback = _link_function('glIsTransformFeedback', GLboolean, [GLuint], requires='OpenGL 3.0')
        self.glIsVertexArray = _link_function('glIsVertexArray', GLboolean, [GLuint], requires='OpenGL 3.0')
        self.glLineWidth = _link_function('glLineWidth', None, [GLfloat], requires='OpenGL 2.0')
        ...
        self.glMemoryBarrier = _link_function('glMemoryBarrier', None, [GLbitfield], requires='OpenGL 3.1')
        self.glMemoryBarrierByRegion = _link_function('glMemoryBarrierByRegion', None, [GLbitfield], requires='OpenGL 3.1')
        self.glMinSampleShading = _link_function('glMinSampleShading', None, [GLfloat], requires='OpenGL 3.2')
        ...
        self.glMultiDrawArraysEXT = _link_function('glMultiDrawArraysEXT', None, [GLenum, POINTER(GLint), POINTER(GLsizei), GLsizei], requires=None)
        ...
        self.glMultiDrawElementsBaseVertexEXT = _link_function('glMultiDrawElementsBaseVertexEXT', None, [GLenum, POINTER(GLsizei), GLenum, POINTER(GLvoid), GLsizei, POINTER(GLint)], requires=None)
        self.glMultiDrawElementsEXT = _link_function('glMultiDrawElementsEXT', None, [GLenum, POINTER(GLsizei), GLenum, POINTER(GLvoid), GLsizei], requires=None)
        ...
        self.glObjectLabel = _link_function('glObjectLabel', None, [GLenum, GLuint, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
        self.glObjectPtrLabel = _link_function('glObjectPtrLabel', None, [POINTER(GLvoid), GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
        self.glPatchParameterfv = _link_function('glPatchParameterfv', None, [GLenum, POINTER(GLfloat)], requires='OpenGL 4.0')
        self.glPatchParameteri = _link_function('glPatchParameteri', None, [GLenum, GLint], requires='OpenGL 3.2')
        self.glPatchParameteriOES = _link_function('glPatchParameteriOES', None, [GLenum, GLint], requires=None)
        self.glPauseTransformFeedback = _link_function('glPauseTransformFeedback', None, [], requires='OpenGL 3.0')
        self.glPixelStoref = _link_function('glPixelStoref', None, [GLenum, GLfloat], requires='OpenGL 1.0')
        self.glPixelStorei = _link_function('glPixelStorei', None, [GLenum, GLint], requires='OpenGL 2.0')
        ...
        self.glPolygonOffset = _link_function('glPolygonOffset', None, [GLfloat, GLfloat], requires='OpenGL 2.0')
        self.glPolygonOffsetClamp = _link_function('glPolygonOffsetClamp', None, [GLfloat, GLfloat, GLfloat], requires='OpenGL 4.6')
        self.glPopDebugGroup = _link_function('glPopDebugGroup', None, [], requires='OpenGL 3.2')
        self.glPrimitiveRestartIndex = _link_function('glPrimitiveRestartIndex', None, [GLuint], requires='OpenGL 3.1')
        self.glProgramBinary = _link_function('glProgramBinary', None, [GLuint, GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 3.0')
        self.glProgramParameteri = _link_function('glProgramParameteri', None, [GLuint, GLenum, GLint], requires='OpenGL 3.0')
        self.glProgramParameteriARB = _link_function('glProgramParameteriARB', None, [GLuint, GLenum, GLint], requires=None)
        self.glProgramParameteriEXT = _link_function('glProgramParameteriEXT', None, [GLuint, GLenum, GLint], requires=None)
        ...
        self.glProgramUniform1f = _link_function('glProgramUniform1f', None, [GLuint, GLint, GLfloat], requires='OpenGL 3.1')
        self.glProgramUniform1fEXT = _link_function('glProgramUniform1fEXT', None, [GLuint, GLint, GLfloat], requires=None)
        self.glProgramUniform1fv = _link_function('glProgramUniform1fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniform1fvEXT = _link_function('glProgramUniform1fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
        self.glProgramUniform1i = _link_function('glProgramUniform1i', None, [GLuint, GLint, GLint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform1iEXT = _link_function('glProgramUniform1iEXT', None, [GLuint, GLint, GLint], requires=None)
        self.glProgramUniform1iv = _link_function('glProgramUniform1iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
        self.glProgramUniform1ivEXT = _link_function('glProgramUniform1ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
        self.glProgramUniform1ui = _link_function('glProgramUniform1ui', None, [GLuint, GLint, GLuint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform1uiEXT = _link_function('glProgramUniform1uiEXT', None, [GLuint, GLint, GLuint], requires=None)
        self.glProgramUniform1uiv = _link_function('glProgramUniform1uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glProgramUniform1uivEXT = _link_function('glProgramUniform1uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
        ...
        self.glProgramUniform2f = _link_function('glProgramUniform2f', None, [GLuint, GLint, GLfloat, GLfloat], requires='OpenGL 3.1')
        self.glProgramUniform2fEXT = _link_function('glProgramUniform2fEXT', None, [GLuint, GLint, GLfloat, GLfloat], requires=None)
        self.glProgramUniform2fv = _link_function('glProgramUniform2fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniform2fvEXT = _link_function('glProgramUniform2fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
        self.glProgramUniform2i = _link_function('glProgramUniform2i', None, [GLuint, GLint, GLint, GLint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform2iEXT = _link_function('glProgramUniform2iEXT', None, [GLuint, GLint, GLint, GLint], requires=None)
        self.glProgramUniform2iv = _link_function('glProgramUniform2iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
        self.glProgramUniform2ivEXT = _link_function('glProgramUniform2ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
        self.glProgramUniform2ui = _link_function('glProgramUniform2ui', None, [GLuint, GLint, GLuint, GLuint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform2uiEXT = _link_function('glProgramUniform2uiEXT', None, [GLuint, GLint, GLuint, GLuint], requires=None)
        self.glProgramUniform2uiv = _link_function('glProgramUniform2uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glProgramUniform2uivEXT = _link_function('glProgramUniform2uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
        ...
        self.glProgramUniform3f = _link_function('glProgramUniform3f', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat], requires='OpenGL 3.1')
        self.glProgramUniform3fEXT = _link_function('glProgramUniform3fEXT', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat], requires=None)
        self.glProgramUniform3fv = _link_function('glProgramUniform3fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniform3fvEXT = _link_function('glProgramUniform3fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
        self.glProgramUniform3i = _link_function('glProgramUniform3i', None, [GLuint, GLint, GLint, GLint, GLint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform3iEXT = _link_function('glProgramUniform3iEXT', None, [GLuint, GLint, GLint, GLint, GLint], requires=None)
        self.glProgramUniform3iv = _link_function('glProgramUniform3iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
        self.glProgramUniform3ivEXT = _link_function('glProgramUniform3ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
        self.glProgramUniform3ui = _link_function('glProgramUniform3ui', None, [GLuint, GLint, GLuint, GLuint, GLuint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform3uiEXT = _link_function('glProgramUniform3uiEXT', None, [GLuint, GLint, GLuint, GLuint, GLuint], requires=None)
        self.glProgramUniform3uiv = _link_function('glProgramUniform3uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glProgramUniform3uivEXT = _link_function('glProgramUniform3uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
        ...
        self.glProgramUniform4f = _link_function('glProgramUniform4f', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 3.1')
        self.glProgramUniform4fEXT = _link_function('glProgramUniform4fEXT', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat], requires=None)
        self.glProgramUniform4fv = _link_function('glProgramUniform4fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniform4fvEXT = _link_function('glProgramUniform4fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
        self.glProgramUniform4i = _link_function('glProgramUniform4i', None, [GLuint, GLint, GLint, GLint, GLint, GLint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform4iEXT = _link_function('glProgramUniform4iEXT', None, [GLuint, GLint, GLint, GLint, GLint, GLint], requires=None)
        self.glProgramUniform4iv = _link_function('glProgramUniform4iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
        self.glProgramUniform4ivEXT = _link_function('glProgramUniform4ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
        self.glProgramUniform4ui = _link_function('glProgramUniform4ui', None, [GLuint, GLint, GLuint, GLuint, GLuint, GLuint], requires='OpenGL 3.1')
        ...
        self.glProgramUniform4uiEXT = _link_function('glProgramUniform4uiEXT', None, [GLuint, GLint, GLuint, GLuint, GLuint, GLuint], requires=None)
        self.glProgramUniform4uiv = _link_function('glProgramUniform4uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
        self.glProgramUniform4uivEXT = _link_function('glProgramUniform4uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
        ...
        self.glProgramUniformMatrix2fv = _link_function('glProgramUniformMatrix2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix2fvEXT = _link_function('glProgramUniformMatrix2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix2x3fv = _link_function('glProgramUniformMatrix2x3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix2x3fvEXT = _link_function('glProgramUniformMatrix2x3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix2x4fv = _link_function('glProgramUniformMatrix2x4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix2x4fvEXT = _link_function('glProgramUniformMatrix2x4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix3fv = _link_function('glProgramUniformMatrix3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix3fvEXT = _link_function('glProgramUniformMatrix3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix3x2fv = _link_function('glProgramUniformMatrix3x2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix3x2fvEXT = _link_function('glProgramUniformMatrix3x2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix3x4fv = _link_function('glProgramUniformMatrix3x4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix3x4fvEXT = _link_function('glProgramUniformMatrix3x4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix4fv = _link_function('glProgramUniformMatrix4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix4fvEXT = _link_function('glProgramUniformMatrix4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix4x2fv = _link_function('glProgramUniformMatrix4x2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix4x2fvEXT = _link_function('glProgramUniformMatrix4x2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        ...
        self.glProgramUniformMatrix4x3fv = _link_function('glProgramUniformMatrix4x3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
        self.glProgramUniformMatrix4x3fvEXT = _link_function('glProgramUniformMatrix4x3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
        self.glProvokingVertex = _link_function('glProvokingVertex', None, [GLenum], requires='OpenGL 3.2')
        self.glPushDebugGroup = _link_function('glPushDebugGroup', None, [GLenum, GLuint, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
        self.glQueryCounter = _link_function('glQueryCounter', None, [GLuint, GLenum], requires='OpenGL 3.3')
        self.glReadBuffer = _link_function('glReadBuffer', None, [GLenum], requires='OpenGL 3.0')
        self.glReadPixels = _link_function('glReadPixels', None, [GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
        self.glReadnPixels = _link_function('glReadnPixels', None, [GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.2')
        self.glReleaseShaderCompiler = _link_function('glReleaseShaderCompiler', None, [], requires='OpenGL 2.0')
        self.glRenderbufferStorage = _link_function('glRenderbufferStorage', None, [GLenum, GLenum, GLsizei, GLsizei], requires='OpenGL 2.0')
        ...
        self.glResumeTransformFeedback = _link_function('glResumeTransformFeedback', None, [], requires='OpenGL 3.0')
        self.glSampleCoverage = _link_function('glSampleCoverage', None, [GLfloat, GLboolean], requires='OpenGL 2.0')
        self.glSampleCoverageARB = _link_function('glSampleCoverageARB', None, [GLfloat, GLboolean], requires=None)
        self.glSampleMaski = _link_function('glSampleMaski', None, [GLuint, GLbitfield], requires='OpenGL 3.1')
        self.glSamplerParameterIiv = _link_function('glSamplerParameterIiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
        self.glSamplerParameterIuiv = _link_function('glSamplerParameterIuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
        self.glSamplerParameterf = _link_function('glSamplerParameterf', None, [GLuint, GLenum, GLfloat], requires='OpenGL 3.0')
        self.glSamplerParameterfv = _link_function('glSamplerParameterfv', None, [GLuint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.0')
        self.glSamplerParameteri = _link_function('glSamplerParameteri', None, [GLuint, GLenum, GLint], requires='OpenGL 3.0')
        self.glSamplerParameteriv = _link_function('glSamplerParameteriv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
        self.glScissor = _link_function('glScissor', None, [GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
        ...
        self.glShaderBinary = _link_function('glShaderBinary', None, [GLsizei, POINTER(GLuint), GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 2.0')
        ...
        self.glStencilFunc = _link_function('glStencilFunc', None, [GLenum, GLint, GLuint], requires='OpenGL 2.0')
        self.glStencilFuncSeparate = _link_function('glStencilFuncSeparate', None, [GLenum, GLenum, GLint, GLuint], requires='OpenGL 2.0')
        self.glStencilMask = _link_function('glStencilMask', None, [GLuint], requires='OpenGL 2.0')
        self.glStencilMaskSeparate = _link_function('glStencilMaskSeparate', None, [GLenum, GLuint], requires='OpenGL 2.0')
        self.glStencilOp = _link_function('glStencilOp', None, [GLenum, GLenum, GLenum], requires='OpenGL 2.0')
        self.glStencilOpSeparate = _link_function('glStencilOpSeparate', None, [GLenum, GLenum, GLenum, GLenum], requires='OpenGL 2.0')
        self.glTexBuffer = _link_function('glTexBuffer', None, [GLenum, GLenum, GLuint], requires='OpenGL 3.2')
        self.glTexBufferRange = _link_function('glTexBufferRange', None, [GLenum, GLenum, GLuint, GLintptr, GLsizeiptr], requires='OpenGL 3.2')
        ...
        self.glTexImage2D = _link_function('glTexImage2D', None, [GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
        ...
        self.glTexImage3D = _link_function('glTexImage3D', None, [GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glTexParameterIiv = _link_function('glTexParameterIiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
        self.glTexParameterIuiv = _link_function('glTexParameterIuiv', None, [GLenum, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
        self.glTexParameterf = _link_function('glTexParameterf', None, [GLenum, GLenum, GLfloat], requires='OpenGL 2.0')
        self.glTexParameterfv = _link_function('glTexParameterfv', None, [GLenum, GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
        self.glTexParameteri = _link_function('glTexParameteri', None, [GLenum, GLenum, GLint], requires='OpenGL 2.0')
        self.glTexParameteriv = _link_function('glTexParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
        self.glTexStorage1D = _link_function('glTexStorage1D', None, [GLenum, GLsizei, GLenum, GLsizei], requires='OpenGL 4.2')
        self.glTexStorage2D = _link_function('glTexStorage2D', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei], requires='OpenGL 3.0')
        self.glTexStorage2DMultisample = _link_function('glTexStorage2DMultisample', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean], requires='OpenGL 3.1')
        self.glTexStorage3D = _link_function('glTexStorage3D', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei], requires='OpenGL 3.0')
        self.glTexStorage3DMultisample = _link_function('glTexStorage3DMultisample', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean], requires='OpenGL 3.2')
        ...
        self.glTexSubImage2D = _link_function('glTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
        self.glTexSubImage3D = _link_function('glTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
        ...
        self.glUniformBlockBinding = _link_function('glUniformBlockBinding', None, [GLuint, GLuint, GLuint], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix2x3fv = _link_function('glUniformMatrix2x3fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix2x4fv = _link_function('glUniformMatrix2x4fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix3x2fv = _link_function('glUniformMatrix3x2fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix3x4fv = _link_function('glUniformMatrix3x4fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix4x2fv = _link_function('glUniformMatrix4x2fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUniformMatrix4x3fv = _link_function('glUniformMatrix4x3fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
        ...
        self.glUnmapBuffer = _link_function('glUnmapBuffer', GLboolean, [GLenum], requires='OpenGL 3.0')
        ...
        self.glUseProgramStages = _link_function('glUseProgramStages', None, [GLuint, GLbitfield, GLuint], requires='OpenGL 3.1')
        self.glUseProgramStagesEXT = _link_function('glUseProgramStagesEXT', None, [GLuint, GLbitfield, GLuint], requires=None)
        self.glUseShaderProgramEXT = _link_function('glUseShaderProgramEXT', None, [GLenum, GLuint], requires=None)
        self.glValidateProgram = _link_function('glValidateProgram', None, [GLuint], requires='OpenGL 2.0')
        self.glValidateProgramPipeline = _link_function('glValidateProgramPipeline', None, [GLuint], requires='OpenGL 3.1')
        self.glValidateProgramPipelineEXT = _link_function('glValidateProgramPipelineEXT', None, [GLuint], requires=None)
        ...
        self.glVertexAttribBinding = _link_function('glVertexAttribBinding', None, [GLuint, GLuint], requires='OpenGL 3.1')
        self.glVertexAttribDivisor = _link_function('glVertexAttribDivisor', None, [GLuint, GLuint], requires='OpenGL 3.0')
        self.glVertexAttribFormat = _link_function('glVertexAttribFormat', None, [GLuint, GLint, GLenum, GLboolean, GLuint], requires='OpenGL 3.1')
        ...
        self.glVertexAttribIFormat = _link_function('glVertexAttribIFormat', None, [GLuint, GLint, GLenum, GLuint], requires='OpenGL 3.1')
        ...
        self.glVertexBindingDivisor = _link_function('glVertexBindingDivisor', None, [GLuint, GLuint], requires='OpenGL 3.1')
        ...
        self.glViewport = _link_function('glViewport', None, [GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
        self.glViewportArrayv = _link_function('glViewportArrayv', None, [GLuint, GLsizei, POINTER(GLfloat)], requires='OpenGL 4.1')
        self.glViewportIndexedf = _link_function('glViewportIndexedf', None, [GLuint, GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 4.1')
        self.glViewportIndexedfv = _link_function('glViewportIndexedfv', None, [GLuint, POINTER(GLfloat)], requires='OpenGL 4.1')
        self.glWaitSync = _link_function('glWaitSync', None, [GLsync, GLbitfield, GLuint64], requires='OpenGL 3.0')

# These functions may be imported before a context is created.
glActiveProgramEXT = _link_function_proxy('glActiveProgramEXT', None, [GLuint], requires=None)
glActiveShaderProgram = _link_function_proxy('glActiveShaderProgram', None, [GLuint, GLuint], requires='OpenGL 3.1')
glActiveShaderProgramEXT = _link_function_proxy('glActiveShaderProgramEXT', None, [GLuint, GLuint], requires=None)
glActiveTexture = _link_function_proxy('glActiveTexture', None, [GLenum], requires='OpenGL 2.0')
...
glBeginQuery = _link_function_proxy('glBeginQuery', None, [GLenum, GLuint], requires='OpenGL 3.0')
...
glBindBuffer = _link_function_proxy('glBindBuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
glBindBufferBase = _link_function_proxy('glBindBufferBase', None, [GLenum, GLuint, GLuint], requires='OpenGL 3.0')
glBindBufferRange = _link_function_proxy('glBindBufferRange', None, [GLenum, GLuint, GLuint, GLintptr, GLsizeiptr], requires='OpenGL 3.0')
...
glBindFramebuffer = _link_function_proxy('glBindFramebuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
glBindFramebufferEXT = _link_function_proxy('glBindFramebufferEXT', None, [GLenum, GLuint], requires=None)
glBindImageTexture = _link_function_proxy('glBindImageTexture', None, [GLuint, GLuint, GLint, GLboolean, GLint, GLenum, GLenum], requires='OpenGL 3.1')
glBindImageTextures = _link_function_proxy('glBindImageTextures', None, [GLuint, GLsizei, POINTER(GLuint)], requires='OpenGL 4.4')
glBindProgramPipeline = _link_function_proxy('glBindProgramPipeline', None, [GLuint], requires='OpenGL 3.1')
glBindProgramPipelineEXT = _link_function_proxy('glBindProgramPipelineEXT', None, [GLuint], requires=None)
glBindRenderbuffer = _link_function_proxy('glBindRenderbuffer', None, [GLenum, GLuint], requires='OpenGL 2.0')
glBindRenderbufferEXT = _link_function_proxy('glBindRenderbufferEXT', None, [GLenum, GLuint], requires=None)
glBindSampler = _link_function_proxy('glBindSampler', None, [GLuint, GLuint], requires='OpenGL 3.0')
glBindSamplers = _link_function_proxy('glBindSamplers', None, [GLuint, GLsizei, POINTER(GLuint)], requires='OpenGL 4.4')
glBindTexture = _link_function_proxy('glBindTexture', None, [GLenum, GLuint], requires='OpenGL 2.0')
...
glBindTransformFeedback = _link_function_proxy('glBindTransformFeedback', None, [GLenum, GLuint], requires='OpenGL 3.0')
glBindVertexArray = _link_function_proxy('glBindVertexArray', None, [GLuint], requires='OpenGL 3.0')
glBindVertexBuffer = _link_function_proxy('glBindVertexBuffer', None, [GLuint, GLuint, GLintptr, GLsizei], requires='OpenGL 3.1')
...
glBlendColor = _link_function_proxy('glBlendColor', None, [GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 2.0')
glBlendEquation = _link_function_proxy('glBlendEquation', None, [GLenum], requires='OpenGL 2.0')
glBlendEquationSeparate = _link_function_proxy('glBlendEquationSeparate', None, [GLenum, GLenum], requires='OpenGL 2.0')
glBlendEquationSeparatei = _link_function_proxy('glBlendEquationSeparatei', None, [GLuint, GLenum, GLenum], requires='OpenGL 3.2')
glBlendEquationi = _link_function_proxy('glBlendEquationi', None, [GLuint, GLenum], requires='OpenGL 3.2')
glBlendFunc = _link_function_proxy('glBlendFunc', None, [GLenum, GLenum], requires='OpenGL 2.0')
glBlendFuncSeparate = _link_function_proxy('glBlendFuncSeparate', None, [GLenum, GLenum, GLenum, GLenum], requires='OpenGL 2.0')
glBlendFuncSeparatei = _link_function_proxy('glBlendFuncSeparatei', None, [GLuint, GLenum, GLenum, GLenum, GLenum], requires='OpenGL 3.2')
glBlendFunci = _link_function_proxy('glBlendFunci', None, [GLuint, GLenum, GLenum], requires='OpenGL 3.2')
...
glBufferData = _link_function_proxy('glBufferData', None, [GLenum, GLsizeiptr, POINTER(GLvoid), GLenum], requires='OpenGL 2.0')
...
glBufferSubData = _link_function_proxy('glBufferSubData', None, [GLenum, GLintptr, GLsizeiptr, POINTER(GLvoid)], requires='OpenGL 2.0')
glCheckFramebufferStatus = _link_function_proxy('glCheckFramebufferStatus', GLenum, [GLenum], requires='OpenGL 2.0')
...
glClear = _link_function_proxy('glClear', None, [GLbitfield], requires='OpenGL 2.0')
...
glClearColor = _link_function_proxy('glClearColor', None, [GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 2.0')
glClearDepth = _link_function_proxy('glClearDepth', None, [GLdouble], requires='OpenGL 1.0')
glClearDepthf = _link_function_proxy('glClearDepthf', None, [GLfloat], requires='OpenGL 2.0')
...
glClearStencil = _link_function_proxy('glClearStencil', None, [GLint], requires='OpenGL 2.0')
...
glClientWaitSync = _link_function_proxy('glClientWaitSync', GLenum, [GLsync, GLbitfield, GLuint64], requires='OpenGL 3.0')
glClipControl = _link_function_proxy('glClipControl', None, [GLenum, GLenum], requires='OpenGL 4.5')
glColorMask = _link_function_proxy('glColorMask', None, [GLboolean, GLboolean, GLboolean, GLboolean], requires='OpenGL 2.0')
glColorMaski = _link_function_proxy('glColorMaski', None, [GLuint, GLboolean, GLboolean, GLboolean, GLboolean], requires='OpenGL 3.2')
...
glCompressedTexImage2D = _link_function_proxy('glCompressedTexImage2D', None, [GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, POINTER(GLvoid)], requires='OpenGL 2.0')
glCompressedTexImage3D = _link_function_proxy('glCompressedTexImage3D', None, [GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glCompressedTexSubImage2D = _link_function_proxy('glCompressedTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 2.0')
glCompressedTexSubImage3D = _link_function_proxy('glCompressedTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glCopyBufferSubData = _link_function_proxy('glCopyBufferSubData', None, [GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr], requires='OpenGL 3.0')
glCopyImageSubData = _link_function_proxy('glCopyImageSubData', None, [GLuint, GLenum, GLint, GLint, GLint, GLint, GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei], requires='OpenGL 3.2')
...
glCopyTexImage2D = _link_function_proxy('glCopyTexImage2D', None, [GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint], requires='OpenGL 2.0')
...
glCopyTexSubImage2D = _link_function_proxy('glCopyTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
glCopyTexSubImage3D = _link_function_proxy('glCopyTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
...
glCreateShaderProgramEXT = _link_function_proxy('glCreateShaderProgramEXT', GLuint, [GLenum, POINTER(GLchar)], requires=None)
glCreateShaderProgramv = _link_function_proxy('glCreateShaderProgramv', GLuint, [GLenum, GLsizei, POINTER(POINTER(GLchar))], requires='OpenGL 3.1')
glCreateShaderProgramvEXT = _link_function_proxy('glCreateShaderProgramvEXT', GLuint, [GLenum, GLsizei, POINTER(POINTER(GLchar))], requires=None)
...
glCullFace = _link_function_proxy('glCullFace', None, [GLenum], requires='OpenGL 2.0')
glDebugMessageCallback = _link_function_proxy('glDebugMessageCallback', None, [GLDEBUGPROC, POINTER(GLvoid)], requires='OpenGL 3.2')
glDebugMessageControl = _link_function_proxy('glDebugMessageControl', None, [GLenum, GLenum, GLenum, GLsizei, POINTER(GLuint), GLboolean], requires='OpenGL 3.2')
glDebugMessageInsert = _link_function_proxy('glDebugMessageInsert', None, [GLenum, GLenum, GLuint, GLenum, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
glDeleteBuffers = _link_function_proxy('glDeleteBuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glDeleteFramebuffers = _link_function_proxy('glDeleteFramebuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
...
glDeleteProgramPipelines = _link_function_proxy('glDeleteProgramPipelines', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glDeleteProgramPipelinesEXT = _link_function_proxy('glDeleteProgramPipelinesEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
glDeleteQueries = _link_function_proxy('glDeleteQueries', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glDeleteRenderbuffers = _link_function_proxy('glDeleteRenderbuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glDeleteRenderbuffersEXT = _link_function_proxy('glDeleteRenderbuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
glDeleteSamplers = _link_function_proxy('glDeleteSamplers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glDeleteShader = _link_function_proxy('glDeleteShader', None, [GLuint], requires='OpenGL 2.0')
glDeleteSync = _link_function_proxy('glDeleteSync', None, [GLsync], requires='OpenGL 3.0')
glDeleteTextures = _link_function_proxy('glDeleteTextures', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glDeleteTransformFeedbacks = _link_function_proxy('glDeleteTransformFeedbacks', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glDeleteVertexArrays = _link_function_proxy('glDeleteVertexArrays', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glDepthFunc = _link_function_proxy('glDepthFunc', None, [GLenum], requires='OpenGL 2.0')
glDepthMask = _link_function_proxy('glDepthMask', None, [GLboolean], requires='OpenGL 2.0')
...
glDepthRangef = _link_function_proxy('glDepthRangef', None, [GLfloat, GLfloat], requires='OpenGL 2.0')
glDetachShader = _link_function_proxy('glDetachShader', None, [GLuint, GLuint], requires='OpenGL 2.0')
glDisable = _link_function_proxy('glDisable', None, [GLenum], requires='OpenGL 2.0')
...
glDisablei = _link_function_proxy('glDisablei', None, [GLenum, GLuint], requires='OpenGL 3.2')
glDispatchCompute = _link_function_proxy('glDispatchCompute', None, [GLuint, GLuint, GLuint], requires='OpenGL 3.1')
glDispatchComputeIndirect = _link_function_proxy('glDispatchComputeIndirect', None, [GLintptr], requires='OpenGL 3.1')
glDrawArrays = _link_function_proxy('glDrawArrays', None, [GLenum, GLint, GLsizei], requires='OpenGL 2.0')
glDrawArraysIndirect = _link_function_proxy('glDrawArraysIndirect', None, [GLenum, POINTER(GLvoid)], requires='OpenGL 3.1')
glDrawArraysInstanced = _link_function_proxy('glDrawArraysInstanced', None, [GLenum, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
...
glDrawBuffers = _link_function_proxy('glDrawBuffers', None, [GLsizei, POINTER(GLenum)], requires='OpenGL 3.0')
glDrawElements = _link_function_proxy('glDrawElements', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
...
glDrawElementsBaseVertexOES = _link_function_proxy('glDrawElementsBaseVertexOES', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLint], requires=None)
glDrawElementsIndirect = _link_function_proxy('glDrawElementsIndirect', None, [GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.1')
glDrawElementsInstanced = _link_function_proxy('glDrawElementsInstanced', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 3.0')
...
glDrawElementsInstancedBaseVertexOES = _link_function_proxy('glDrawElementsInstancedBaseVertexOES', None, [GLenum, GLsizei, GLenum, POINTER(GLvoid), GLsizei, GLint], requires=None)
...
glDrawRangeElements = _link_function_proxy('glDrawRangeElements', None, [GLenum, GLuint, GLuint, GLsizei, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glDrawRangeElementsBaseVertexOES = _link_function_proxy('glDrawRangeElementsBaseVertexOES', None, [GLenum, GLuint, GLuint, GLsizei, GLenum, POINTER(GLvoid), GLint], requires=None)
...
glEnable = _link_function_proxy('glEnable', None, [GLenum], requires='OpenGL 2.0')
...
glEnablei = _link_function_proxy('glEnablei', None, [GLenum, GLuint], requires='OpenGL 3.2')
glEndConditionalRender = _link_function_proxy('glEndConditionalRender', None, [], requires='OpenGL 3.0')
glEndQuery = _link_function_proxy('glEndQuery', None, [GLenum], requires='OpenGL 3.0')
...
glFenceSync = _link_function_proxy('glFenceSync', GLsync, [GLenum, GLbitfield], requires='OpenGL 3.0')
glFinish = _link_function_proxy('glFinish', None, [], requires='OpenGL 2.0')
glFlush = _link_function_proxy('glFlush', None, [], requires='OpenGL 2.0')
...
glFramebufferParameteri = _link_function_proxy('glFramebufferParameteri', None, [GLenum, GLenum, GLint], requires='OpenGL 3.1')
glFramebufferRenderbuffer = _link_function_proxy('glFramebufferRenderbuffer', None, [GLenum, GLenum, GLenum, GLuint], requires='OpenGL 2.0')
...
glFramebufferTexture2D = _link_function_proxy('glFramebufferTexture2D', None, [GLenum, GLenum, GLenum, GLuint, GLint], requires='OpenGL 2.0')
...
glFramebufferTextureARB = _link_function_proxy('glFramebufferTextureARB', None, [GLenum, GLenum, GLuint, GLint], requires=None)
glFramebufferTextureEXT = _link_function_proxy('glFramebufferTextureEXT', None, [GLenum, GLenum, GLuint, GLint], requires=None)
glFramebufferTextureFaceARB = _link_function_proxy('glFramebufferTextureFaceARB', None, [GLenum, GLenum, GLuint, GLint, GLenum], requires=None)
...
glFramebufferTextureLayerARB = _link_function_proxy('glFramebufferTextureLayerARB', None, [GLenum, GLenum, GLuint, GLint, GLint], requires=None)
glFrontFace = _link_function_proxy('glFrontFace', None, [GLenum], requires='OpenGL 2.0')
glGenBuffers = _link_function_proxy('glGenBuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glGenFramebuffers = _link_function_proxy('glGenFramebuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glGenFramebuffersEXT = _link_function_proxy('glGenFramebuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
glGenProgramPipelines = _link_function_proxy('glGenProgramPipelines', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glGenProgramPipelinesEXT = _link_function_proxy('glGenProgramPipelinesEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
glGenQueries = _link_function_proxy('glGenQueries', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glGenRenderbuffers = _link_function_proxy('glGenRenderbuffers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glGenRenderbuffersEXT = _link_function_proxy('glGenRenderbuffersEXT', None, [GLsizei, POINTER(GLuint)], requires=None)
glGenSamplers = _link_function_proxy('glGenSamplers', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glGenTextures = _link_function_proxy('glGenTextures', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 2.0')
glGenTransformFeedbacks = _link_function_proxy('glGenTransformFeedbacks', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glGenVertexArrays = _link_function_proxy('glGenVertexArrays', None, [GLsizei, POINTER(GLuint)], requires='OpenGL 3.0')
glGenerateMipmap = _link_function_proxy('glGenerateMipmap', None, [GLenum], requires='OpenGL 2.0')
...
glGetActiveUniformBlockName = _link_function_proxy('glGetActiveUniformBlockName', None, [GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.0')
glGetActiveUniformBlockiv = _link_function_proxy('glGetActiveUniformBlockiv', None, [GLuint, GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
...
glGetActiveUniformsiv = _link_function_proxy('glGetActiveUniformsiv', None, [GLuint, GLsizei, POINTER(GLuint), GLenum, POINTER(GLint)], requires='OpenGL 3.0')
...
glGetBooleani_v = _link_function_proxy('glGetBooleani_v', None, [GLenum, GLuint, POINTER(GLboolean)], requires='OpenGL 3.1')
glGetBooleanv = _link_function_proxy('glGetBooleanv', None, [GLenum, POINTER(GLboolean)], requires='OpenGL 2.0')
glGetBufferParameteri64v = _link_function_proxy('glGetBufferParameteri64v', None, [GLenum, GLenum, POINTER(GLint64)], requires='OpenGL 3.0')
glGetBufferParameteriv = _link_function_proxy('glGetBufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
glGetBufferPointerv = _link_function_proxy('glGetBufferPointerv', None, [GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glGetDebugMessageLog = _link_function_proxy('glGetDebugMessageLog', GLuint, [GLuint, GLsizei, POINTER(GLenum), POINTER(GLenum), POINTER(GLuint), POINTER(GLenum), POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
...
glGetError = _link_function_proxy('glGetError', GLenum, [], requires='OpenGL 2.0')
glGetFloati_v = _link_function_proxy('glGetFloati_v', None, [GLenum, GLuint, POINTER(GLfloat)], requires='OpenGL 4.1')
glGetFloatv = _link_function_proxy('glGetFloatv', None, [GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
...
glGetFramebufferAttachmentParameteriv = _link_function_proxy('glGetFramebufferAttachmentParameteriv', None, [GLenum, GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
...
glGetFramebufferParameteriv = _link_function_proxy('glGetFramebufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
glGetGraphicsResetStatus = _link_function_proxy('glGetGraphicsResetStatus', GLenum, [], requires='OpenGL 3.2')
glGetImageHandleARB = _link_function_proxy('glGetImageHandleARB', GLuint64, [GLuint, GLint, GLboolean, GLint, GLenum], requires=None)
glGetInteger64i_v = _link_function_proxy('glGetInteger64i_v', None, [GLenum, GLuint, POINTER(GLint64)], requires='OpenGL 3.0')
glGetInteger64v = _link_function_proxy('glGetInteger64v', None, [GLenum, POINTER(GLint64)], requires='OpenGL 3.0')
glGetIntegeri_v = _link_function_proxy('glGetIntegeri_v', None, [GLenum, GLuint, POINTER(GLint)], requires='OpenGL 3.0')
glGetIntegerv = _link_function_proxy('glGetIntegerv', None, [GLenum, POINTER(GLint)], requires='OpenGL 2.0')
...
glGetInternalformativ = _link_function_proxy('glGetInternalformativ', None, [GLenum, GLenum, GLenum, GLsizei, POINTER(GLint)], requires='OpenGL 3.0')
glGetMultisamplefv = _link_function_proxy('glGetMultisamplefv', None, [GLenum, GLuint, POINTER(GLfloat)], requires='OpenGL 3.1')
...
glGetObjectLabel = _link_function_proxy('glGetObjectLabel', None, [GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
glGetObjectPtrLabel = _link_function_proxy('glGetObjectPtrLabel', None, [POINTER(GLvoid), GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.2')
glGetPointerv = _link_function_proxy('glGetPointerv', None, [GLenum, POINTER(GLvoid)], requires='OpenGL 3.2')
glGetProgramBinary = _link_function_proxy('glGetProgramBinary', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLenum), POINTER(GLvoid)], requires='OpenGL 3.0')
...
glGetProgramInterfaceiv = _link_function_proxy('glGetProgramInterfaceiv', None, [GLuint, GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
glGetProgramPipelineInfoLog = _link_function_proxy('glGetProgramPipelineInfoLog', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.1')
glGetProgramPipelineInfoLogEXT = _link_function_proxy('glGetProgramPipelineInfoLogEXT', None, [GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires=None)
glGetProgramPipelineiv = _link_function_proxy('glGetProgramPipelineiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
glGetProgramPipelineivEXT = _link_function_proxy('glGetProgramPipelineivEXT', None, [GLuint, GLenum, POINTER(GLint)], requires=None)
glGetProgramResourceIndex = _link_function_proxy('glGetProgramResourceIndex', GLuint, [GLuint, GLenum, POINTER(GLchar)], requires='OpenGL 3.1')
glGetProgramResourceLocation = _link_function_proxy('glGetProgramResourceLocation', GLint, [GLuint, GLenum, POINTER(GLchar)], requires='OpenGL 3.1')
...
glGetProgramResourceName = _link_function_proxy('glGetProgramResourceName', None, [GLuint, GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar)], requires='OpenGL 3.1')
glGetProgramResourceiv = _link_function_proxy('glGetProgramResourceiv', None, [GLuint, GLenum, GLuint, GLsizei, POINTER(GLenum), GLsizei, POINTER(GLsizei), POINTER(GLint)], requires='OpenGL 3.1')
...
glGetQueryObjectuiv = _link_function_proxy('glGetQueryObjectuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.0')
glGetQueryiv = _link_function_proxy('glGetQueryiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
glGetRenderbufferParameteriv = _link_function_proxy('glGetRenderbufferParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
...
glGetSamplerParameterIiv = _link_function_proxy('glGetSamplerParameterIiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
glGetSamplerParameterIuiv = _link_function_proxy('glGetSamplerParameterIuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
glGetSamplerParameterfv = _link_function_proxy('glGetSamplerParameterfv', None, [GLuint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.0')
glGetSamplerParameteriv = _link_function_proxy('glGetSamplerParameteriv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
...
glGetShaderPrecisionFormat = _link_function_proxy('glGetShaderPrecisionFormat', None, [GLenum, GLenum, POINTER(GLint), POINTER(GLint)], requires='OpenGL 2.0')
...
glGetString = _link_function_proxy('glGetString', POINTER(GLubyte), [GLenum], requires='OpenGL 2.0')
...
glGetSynciv = _link_function_proxy('glGetSynciv', None, [GLsync, GLenum, GLsizei, POINTER(GLsizei), POINTER(GLint)], requires='OpenGL 3.0')
glGetTexImage = _link_function_proxy('glGetTexImage', None, [GLenum, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 1.0')
glGetTexLevelParameterfv = _link_function_proxy('glGetTexLevelParameterfv', None, [GLenum, GLint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.1')
glGetTexLevelParameteriv = _link_function_proxy('glGetTexLevelParameteriv', None, [GLenum, GLint, GLenum, POINTER(GLint)], requires='OpenGL 3.1')
glGetTexParameterIiv = _link_function_proxy('glGetTexParameterIiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
glGetTexParameterIuiv = _link_function_proxy('glGetTexParameterIuiv', None, [GLenum, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
glGetTexParameterfv = _link_function_proxy('glGetTexParameterfv', None, [GLenum, GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
glGetTexParameteriv = _link_function_proxy('glGetTexParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
...
glGetUniformBlockIndex = _link_function_proxy('glGetUniformBlockIndex', GLuint, [GLuint, POINTER(GLchar)], requires='OpenGL 3.0')
glGetUniformIndices = _link_function_proxy('glGetUniformIndices', None, [GLuint, GLsizei, POINTER(POINTER(GLchar)), POINTER(GLuint)], requires='OpenGL 3.0')
...
glGetnUniformfv = _link_function_proxy('glGetnUniformfv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.2')
glGetnUniformi64vARB = _link_function_proxy('glGetnUniformi64vARB', None, [GLuint, GLint, GLsizei, POINTER(GLint64)], requires=None)
glGetnUniformiv = _link_function_proxy('glGetnUniformiv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.2')
...
glGetnUniformuiv = _link_function_proxy('glGetnUniformuiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.2')
glHint = _link_function_proxy('glHint', None, [GLenum, GLenum], requires='OpenGL 2.0')
...
glInvalidateFramebuffer = _link_function_proxy('glInvalidateFramebuffer', None, [GLenum, GLsizei, POINTER(GLenum)], requires='OpenGL 3.0')
...
glInvalidateSubFramebuffer = _link_function_proxy('glInvalidateSubFramebuffer', None, [GLenum, GLsizei, POINTER(GLenum), GLint, GLint, GLsizei, GLsizei], requires='OpenGL 3.0')
...
glIsBuffer = _link_function_proxy('glIsBuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
glIsEnabled = _link_function_proxy('glIsEnabled', GLboolean, [GLenum], requires='OpenGL 2.0')
glIsEnabledi = _link_function_proxy('glIsEnabledi', GLboolean, [GLenum, GLuint], requires='OpenGL 3.2')
glIsFramebuffer = _link_function_proxy('glIsFramebuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
...
glIsProgramPipeline = _link_function_proxy('glIsProgramPipeline', GLboolean, [GLuint], requires='OpenGL 3.1')
glIsProgramPipelineEXT = _link_function_proxy('glIsProgramPipelineEXT', GLboolean, [GLuint], requires=None)
glIsQuery = _link_function_proxy('glIsQuery', GLboolean, [GLuint], requires='OpenGL 3.0')
glIsRenderbuffer = _link_function_proxy('glIsRenderbuffer', GLboolean, [GLuint], requires='OpenGL 2.0')
glIsRenderbufferEXT = _link_function_proxy('glIsRenderbufferEXT', GLboolean, [GLuint], requires=None)
glIsSampler = _link_function_proxy('glIsSampler', GLboolean, [GLuint], requires='OpenGL 3.0')
glIsShader = _link_function_proxy('glIsShader', GLboolean, [GLuint], requires='OpenGL 2.0')
glIsSync = _link_function_proxy('glIsSync', GLboolean, [GLsync], requires='OpenGL 3.0')
glIsTexture = _link_function_proxy('glIsTexture', GLboolean, [GLuint], requires='OpenGL 2.0')
glIsTextureHandleResidentARB = _link_function_proxy('glIsTextureHandleResidentARB', GLboolean, [GLuint64], requires=None)
glIsTransformFeedback = _link_function_proxy('glIsTransformFeedback', GLboolean, [GLuint], requires='OpenGL 3.0')
glIsVertexArray = _link_function_proxy('glIsVertexArray', GLboolean, [GLuint], requires='OpenGL 3.0')
glLineWidth = _link_function_proxy('glLineWidth', None, [GLfloat], requires='OpenGL 2.0')
...
glMemoryBarrier = _link_function_proxy('glMemoryBarrier', None, [GLbitfield], requires='OpenGL 3.1')
glMemoryBarrierByRegion = _link_function_proxy('glMemoryBarrierByRegion', None, [GLbitfield], requires='OpenGL 3.1')
glMinSampleShading = _link_function_proxy('glMinSampleShading', None, [GLfloat], requires='OpenGL 3.2')
...
glMultiDrawArraysEXT = _link_function_proxy('glMultiDrawArraysEXT', None, [GLenum, POINTER(GLint), POINTER(GLsizei), GLsizei], requires=None)
...
glMultiDrawElementsBaseVertexEXT = _link_function_proxy('glMultiDrawElementsBaseVertexEXT', None, [GLenum, POINTER(GLsizei), GLenum, POINTER(GLvoid), GLsizei, POINTER(GLint)], requires=None)
glMultiDrawElementsEXT = _link_function_proxy('glMultiDrawElementsEXT', None, [GLenum, POINTER(GLsizei), GLenum, POINTER(GLvoid), GLsizei], requires=None)
...
glObjectLabel = _link_function_proxy('glObjectLabel', None, [GLenum, GLuint, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
glObjectPtrLabel = _link_function_proxy('glObjectPtrLabel', None, [POINTER(GLvoid), GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
glPatchParameterfv = _link_function_proxy('glPatchParameterfv', None, [GLenum, POINTER(GLfloat)], requires='OpenGL 4.0')
glPatchParameteri = _link_function_proxy('glPatchParameteri', None, [GLenum, GLint], requires='OpenGL 3.2')
glPatchParameteriOES = _link_function_proxy('glPatchParameteriOES', None, [GLenum, GLint], requires=None)
glPauseTransformFeedback = _link_function_proxy('glPauseTransformFeedback', None, [], requires='OpenGL 3.0')
glPixelStoref = _link_function_proxy('glPixelStoref', None, [GLenum, GLfloat], requires='OpenGL 1.0')
glPixelStorei = _link_function_proxy('glPixelStorei', None, [GLenum, GLint], requires='OpenGL 2.0')
...
glPolygonOffset = _link_function_proxy('glPolygonOffset', None, [GLfloat, GLfloat], requires='OpenGL 2.0')
glPolygonOffsetClamp = _link_function_proxy('glPolygonOffsetClamp', None, [GLfloat, GLfloat, GLfloat], requires='OpenGL 4.6')
glPopDebugGroup = _link_function_proxy('glPopDebugGroup', None, [], requires='OpenGL 3.2')
glPrimitiveRestartIndex = _link_function_proxy('glPrimitiveRestartIndex', None, [GLuint], requires='OpenGL 3.1')
glProgramBinary = _link_function_proxy('glProgramBinary', None, [GLuint, GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 3.0')
glProgramParameteri = _link_function_proxy('glProgramParameteri', None, [GLuint, GLenum, GLint], requires='OpenGL 3.0')
glProgramParameteriARB = _link_function_proxy('glProgramParameteriARB', None, [GLuint, GLenum, GLint], requires=None)
glProgramParameteriEXT = _link_function_proxy('glProgramParameteriEXT', None, [GLuint, GLenum, GLint], requires=None)
...
glProgramUniform1f = _link_function_proxy('glProgramUniform1f', None, [GLuint, GLint, GLfloat], requires='OpenGL 3.1')
glProgramUniform1fEXT = _link_function_proxy('glProgramUniform1fEXT', None, [GLuint, GLint, GLfloat], requires=None)
glProgramUniform1fv = _link_function_proxy('glProgramUniform1fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniform1fvEXT = _link_function_proxy('glProgramUniform1fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
glProgramUniform1i = _link_function_proxy('glProgramUniform1i', None, [GLuint, GLint, GLint], requires='OpenGL 3.1')
...
glProgramUniform1iEXT = _link_function_proxy('glProgramUniform1iEXT', None, [GLuint, GLint, GLint], requires=None)
glProgramUniform1iv = _link_function_proxy('glProgramUniform1iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
glProgramUniform1ivEXT = _link_function_proxy('glProgramUniform1ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
glProgramUniform1ui = _link_function_proxy('glProgramUniform1ui', None, [GLuint, GLint, GLuint], requires='OpenGL 3.1')
...
glProgramUniform1uiEXT = _link_function_proxy('glProgramUniform1uiEXT', None, [GLuint, GLint, GLuint], requires=None)
glProgramUniform1uiv = _link_function_proxy('glProgramUniform1uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glProgramUniform1uivEXT = _link_function_proxy('glProgramUniform1uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
...
glProgramUniform2f = _link_function_proxy('glProgramUniform2f', None, [GLuint, GLint, GLfloat, GLfloat], requires='OpenGL 3.1')
glProgramUniform2fEXT = _link_function_proxy('glProgramUniform2fEXT', None, [GLuint, GLint, GLfloat, GLfloat], requires=None)
glProgramUniform2fv = _link_function_proxy('glProgramUniform2fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniform2fvEXT = _link_function_proxy('glProgramUniform2fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
glProgramUniform2i = _link_function_proxy('glProgramUniform2i', None, [GLuint, GLint, GLint, GLint], requires='OpenGL 3.1')
...
glProgramUniform2iEXT = _link_function_proxy('glProgramUniform2iEXT', None, [GLuint, GLint, GLint, GLint], requires=None)
glProgramUniform2iv = _link_function_proxy('glProgramUniform2iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
glProgramUniform2ivEXT = _link_function_proxy('glProgramUniform2ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
glProgramUniform2ui = _link_function_proxy('glProgramUniform2ui', None, [GLuint, GLint, GLuint, GLuint], requires='OpenGL 3.1')
...
glProgramUniform2uiEXT = _link_function_proxy('glProgramUniform2uiEXT', None, [GLuint, GLint, GLuint, GLuint], requires=None)
glProgramUniform2uiv = _link_function_proxy('glProgramUniform2uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glProgramUniform2uivEXT = _link_function_proxy('glProgramUniform2uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
...
glProgramUniform3f = _link_function_proxy('glProgramUniform3f', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat], requires='OpenGL 3.1')
glProgramUniform3fEXT = _link_function_proxy('glProgramUniform3fEXT', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat], requires=None)
glProgramUniform3fv = _link_function_proxy('glProgramUniform3fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniform3fvEXT = _link_function_proxy('glProgramUniform3fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
glProgramUniform3i = _link_function_proxy('glProgramUniform3i', None, [GLuint, GLint, GLint, GLint, GLint], requires='OpenGL 3.1')
...
glProgramUniform3iEXT = _link_function_proxy('glProgramUniform3iEXT', None, [GLuint, GLint, GLint, GLint, GLint], requires=None)
glProgramUniform3iv = _link_function_proxy('glProgramUniform3iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
glProgramUniform3ivEXT = _link_function_proxy('glProgramUniform3ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
glProgramUniform3ui = _link_function_proxy('glProgramUniform3ui', None, [GLuint, GLint, GLuint, GLuint, GLuint], requires='OpenGL 3.1')
...
glProgramUniform3uiEXT = _link_function_proxy('glProgramUniform3uiEXT', None, [GLuint, GLint, GLuint, GLuint, GLuint], requires=None)
glProgramUniform3uiv = _link_function_proxy('glProgramUniform3uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glProgramUniform3uivEXT = _link_function_proxy('glProgramUniform3uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
...
glProgramUniform4f = _link_function_proxy('glProgramUniform4f', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat], requires='OpenGL 3.1')
glProgramUniform4fEXT = _link_function_proxy('glProgramUniform4fEXT', None, [GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat], requires=None)
glProgramUniform4fv = _link_function_proxy('glProgramUniform4fv', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniform4fvEXT = _link_function_proxy('glProgramUniform4fvEXT', None, [GLuint, GLint, GLsizei, POINTER(GLfloat)], requires=None)
glProgramUniform4i = _link_function_proxy('glProgramUniform4i', None, [GLuint, GLint, GLint, GLint, GLint, GLint], requires='OpenGL 3.1')
...
glProgramUniform4iEXT = _link_function_proxy('glProgramUniform4iEXT', None, [GLuint, GLint, GLint, GLint, GLint, GLint], requires=None)
glProgramUniform4iv = _link_function_proxy('glProgramUniform4iv', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires='OpenGL 3.1')
glProgramUniform4ivEXT = _link_function_proxy('glProgramUniform4ivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLint)], requires=None)
glProgramUniform4ui = _link_function_proxy('glProgramUniform4ui', None, [GLuint, GLint, GLuint, GLuint, GLuint, GLuint], requires='OpenGL 3.1')
...
glProgramUniform4uiEXT = _link_function_proxy('glProgramUniform4uiEXT', None, [GLuint, GLint, GLuint, GLuint, GLuint, GLuint], requires=None)
glProgramUniform4uiv = _link_function_proxy('glProgramUniform4uiv', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires='OpenGL 3.1')
glProgramUniform4uivEXT = _link_function_proxy('glProgramUniform4uivEXT', None, [GLuint, GLint, GLsizei, POINTER(GLuint)], requires=None)
...
glProgramUniformMatrix2fv = _link_function_proxy('glProgramUniformMatrix2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix2fvEXT = _link_function_proxy('glProgramUniformMatrix2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix2x3fv = _link_function_proxy('glProgramUniformMatrix2x3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix2x3fvEXT = _link_function_proxy('glProgramUniformMatrix2x3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix2x4fv = _link_function_proxy('glProgramUniformMatrix2x4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix2x4fvEXT = _link_function_proxy('glProgramUniformMatrix2x4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix3fv = _link_function_proxy('glProgramUniformMatrix3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix3fvEXT = _link_function_proxy('glProgramUniformMatrix3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix3x2fv = _link_function_proxy('glProgramUniformMatrix3x2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix3x2fvEXT = _link_function_proxy('glProgramUniformMatrix3x2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix3x4fv = _link_function_proxy('glProgramUniformMatrix3x4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix3x4fvEXT = _link_function_proxy('glProgramUniformMatrix3x4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix4fv = _link_function_proxy('glProgramUniformMatrix4fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix4fvEXT = _link_function_proxy('glProgramUniformMatrix4fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix4x2fv = _link_function_proxy('glProgramUniformMatrix4x2fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix4x2fvEXT = _link_function_proxy('glProgramUniformMatrix4x2fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
...
glProgramUniformMatrix4x3fv = _link_function_proxy('glProgramUniformMatrix4x3fv', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.1')
glProgramUniformMatrix4x3fvEXT = _link_function_proxy('glProgramUniformMatrix4x3fvEXT', None, [GLuint, GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires=None)
glProvokingVertex = _link_function_proxy('glProvokingVertex', None, [GLenum], requires='OpenGL 3.2')
glPushDebugGroup = _link_function_proxy('glPushDebugGroup', None, [GLenum, GLuint, GLsizei, POINTER(GLchar)], requires='OpenGL 3.2')
glQueryCounter = _link_function_proxy('glQueryCounter', None, [GLuint, GLenum], requires='OpenGL 3.3')
glReadBuffer = _link_function_proxy('glReadBuffer', None, [GLenum], requires='OpenGL 3.0')
glReadPixels = _link_function_proxy('glReadPixels', None, [GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
glReadnPixels = _link_function_proxy('glReadnPixels', None, [GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, POINTER(GLvoid)], requires='OpenGL 3.2')
glReleaseShaderCompiler = _link_function_proxy('glReleaseShaderCompiler', None, [], requires='OpenGL 2.0')
glRenderbufferStorage = _link_function_proxy('glRenderbufferStorage', None, [GLenum, GLenum, GLsizei, GLsizei], requires='OpenGL 2.0')
...
glResumeTransformFeedback = _link_function_proxy('glResumeTransformFeedback', None, [], requires='OpenGL 3.0')
glSampleCoverage = _link_function_proxy('glSampleCoverage', None, [GLfloat, GLboolean], requires='OpenGL 2.0')
glSampleCoverageARB = _link_function_proxy('glSampleCoverageARB', None, [GLfloat, GLboolean], requires=None)
glSampleMaski = _link_function_proxy('glSampleMaski', None, [GLuint, GLbitfield], requires='OpenGL 3.1')
glSamplerParameterIiv = _link_function_proxy('glSamplerParameterIiv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
glSamplerParameterIuiv = _link_function_proxy('glSamplerParameterIuiv', None, [GLuint, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
glSamplerParameterf = _link_function_proxy('glSamplerParameterf', None, [GLuint, GLenum, GLfloat], requires='OpenGL 3.0')
glSamplerParameterfv = _link_function_proxy('glSamplerParameterfv', None, [GLuint, GLenum, POINTER(GLfloat)], requires='OpenGL 3.0')
glSamplerParameteri = _link_function_proxy('glSamplerParameteri', None, [GLuint, GLenum, GLint], requires='OpenGL 3.0')
glSamplerParameteriv = _link_function_proxy('glSamplerParameteriv', None, [GLuint, GLenum, POINTER(GLint)], requires='OpenGL 3.0')
glScissor = _link_function_proxy('glScissor', None, [GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
...
glShaderBinary = _link_function_proxy('glShaderBinary', None, [GLsizei, POINTER(GLuint), GLenum, POINTER(GLvoid), GLsizei], requires='OpenGL 2.0')
...
glStencilFunc = _link_function_proxy('glStencilFunc', None, [GLenum, GLint, GLuint], requires='OpenGL 2.0')
glStencilFuncSeparate = _link_function_proxy('glStencilFuncSeparate', None, [GLenum, GLenum, GLint, GLuint], requires='OpenGL 2.0')
glStencilMask = _link_function_proxy('glStencilMask', None, [GLuint], requires='OpenGL 2.0')
glStencilMaskSeparate = _link_function_proxy('glStencilMaskSeparate', None, [GLenum, GLuint], requires='OpenGL 2.0')
glStencilOp = _link_function_proxy('glStencilOp', None, [GLenum, GLenum, GLenum], requires='OpenGL 2.0')
glStencilOpSeparate = _link_function_proxy('glStencilOpSeparate', None, [GLenum, GLenum, GLenum, GLenum], requires='OpenGL 2.0')
glTexBuffer = _link_function_proxy('glTexBuffer', None, [GLenum, GLenum, GLuint], requires='OpenGL 3.2')
glTexBufferRange = _link_function_proxy('glTexBufferRange', None, [GLenum, GLenum, GLuint, GLintptr, GLsizeiptr], requires='OpenGL 3.2')
...
glTexImage2D = _link_function_proxy('glTexImage2D', None, [GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
...
glTexImage3D = _link_function_proxy('glTexImage3D', None, [GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glTexParameterIiv = _link_function_proxy('glTexParameterIiv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 3.2')
glTexParameterIuiv = _link_function_proxy('glTexParameterIuiv', None, [GLenum, GLenum, POINTER(GLuint)], requires='OpenGL 3.2')
glTexParameterf = _link_function_proxy('glTexParameterf', None, [GLenum, GLenum, GLfloat], requires='OpenGL 2.0')
glTexParameterfv = _link_function_proxy('glTexParameterfv', None, [GLenum, GLenum, POINTER(GLfloat)], requires='OpenGL 2.0')
glTexParameteri = _link_function_proxy('glTexParameteri', None, [GLenum, GLenum, GLint], requires='OpenGL 2.0')
glTexParameteriv = _link_function_proxy('glTexParameteriv', None, [GLenum, GLenum, POINTER(GLint)], requires='OpenGL 2.0')
glTexStorage1D = _link_function_proxy('glTexStorage1D', None, [GLenum, GLsizei, GLenum, GLsizei], requires='OpenGL 4.2')
glTexStorage2D = _link_function_proxy('glTexStorage2D', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei], requires='OpenGL 3.0')
glTexStorage2DMultisample = _link_function_proxy('glTexStorage2DMultisample', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean], requires='OpenGL 3.1')
glTexStorage3D = _link_function_proxy('glTexStorage3D', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei], requires='OpenGL 3.0')
glTexStorage3DMultisample = _link_function_proxy('glTexStorage3DMultisample', None, [GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean], requires='OpenGL 3.2')
...
glTexSubImage2D = _link_function_proxy('glTexSubImage2D', None, [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 2.0')
glTexSubImage3D = _link_function_proxy('glTexSubImage3D', None, [GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, POINTER(GLvoid)], requires='OpenGL 3.0')
...
glUniformBlockBinding = _link_function_proxy('glUniformBlockBinding', None, [GLuint, GLuint, GLuint], requires='OpenGL 3.0')
...
glUniformMatrix2x3fv = _link_function_proxy('glUniformMatrix2x3fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUniformMatrix2x4fv = _link_function_proxy('glUniformMatrix2x4fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUniformMatrix3x2fv = _link_function_proxy('glUniformMatrix3x2fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUniformMatrix3x4fv = _link_function_proxy('glUniformMatrix3x4fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUniformMatrix4x2fv = _link_function_proxy('glUniformMatrix4x2fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUniformMatrix4x3fv = _link_function_proxy('glUniformMatrix4x3fv', None, [GLint, GLsizei, GLboolean, POINTER(GLfloat)], requires='OpenGL 3.0')
...
glUnmapBuffer = _link_function_proxy('glUnmapBuffer', GLboolean, [GLenum], requires='OpenGL 3.0')
...
glUseProgramStages = _link_function_proxy('glUseProgramStages', None, [GLuint, GLbitfield, GLuint], requires='OpenGL 3.1')
glUseProgramStagesEXT = _link_function_proxy('glUseProgramStagesEXT', None, [GLuint, GLbitfield, GLuint], requires=None)
glUseShaderProgramEXT = _link_function_proxy('glUseShaderProgramEXT', None, [GLenum, GLuint], requires=None)
glValidateProgram = _link_function_proxy('glValidateProgram', None, [GLuint], requires='OpenGL 2.0')
glValidateProgramPipeline = _link_function_proxy('glValidateProgramPipeline', None, [GLuint], requires='OpenGL 3.1')
glValidateProgramPipelineEXT = _link_function_proxy('glValidateProgramPipelineEXT', None, [GLuint], requires=None)
...
glVertexAttribBinding = _link_function_proxy('glVertexAttribBinding', None, [GLuint, GLuint], requires='OpenGL 3.1')
glVertexAttribDivisor = _link_function_proxy('glVertexAttribDivisor', None, [GLuint, GLuint], requires='OpenGL 3.0')
glVertexAttribFormat = _link_function_proxy('glVertexAttribFormat', None, [GLuint, GLint, GLenum, GLboolean, GLuint], requires='OpenGL 3.1')
...
glVertexAttribIFormat = _link_function_proxy('glVertexAttribIFormat', None, [GLuint, GLint, GLenum, GLuint], requires='OpenGL 3.1')
...
glVertexBindingDivisor = _link_function_proxy('glVertexBindingDivisor', None, [GLuint, GLuint], requires='OpenGL 3.1')
...
glViewport = _link_function_proxy('glViewport', None, [GLint, GLint, GLsizei, GLsizei], requires='OpenGL 2.0')
...
glWaitSync = _link_function_proxy('glWaitSync', None, [GLsync, GLbitfield, GLuint64], requires='OpenGL 3.0')
