...
import pyglet
from .layout_sdf import SDFTextLayout
...
class DistFieldFont(UserDefinedFontBase):
    ...
    def __init__(
        ...
        Args:
            ...
            weight:
                ...
                font object.
            style:
                This is not the style of your font, but an identifier when passing to a label to match this
                font object.
            stretch:
        ...
        super().__init__(name, " ", size, ascent, descent, weight, style, stretch, dpi, locale)
    ...
    def _load_sdf_atlas(self, image_path: str | Path, json_path: str | Path) -> tuple[Texture, dict, dict]:
        ...
        """
        atlas_image = pyglet.resource.texture(image_path)
